...
import ProfileFromOther from "../pages/user/ProfileFromOther";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/"
          element={<ProtectRoutes layout={<Layout />} allows={[""]} />}
        >
          ...
          <Route path="profile/:creatorId" element={<ProfileFromOther />} />
        </Route>

        {/* Private */}
        <Route
          path="/user"
          element={<ProtectRoutes layout={<LayoutUser />} allows={["USER"]} />}
        >
        ...
        <Route
          path="/admin"
          element={
            <ProtectRoutes layout={<LayoutAdmin />} allows={["ADMIN"]} />
          }
        >
